"""
Continuous Transcription Sample
This script will run through a session utilizing a Transcription interaction with Continuous Transcription enabled.
...
def transcription_interaction_data_setup(lumenvox_api_client: lumenvox_api_handler.LumenVoxApiClient) \
    ...
    Transcription with Continuous Transcription enabled will result in partial results being returned.
    ...
    # Boolean value used to enable Continuous Transcription.
    continuous_utterance_transcription = True
    ...
    interaction_data.continuous_utterance_transcription = continuous_utterance_transcription
    interaction_data.print_partial_results = True   # Cont. Transcription returns partial results.
